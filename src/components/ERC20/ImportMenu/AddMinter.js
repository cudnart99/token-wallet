...
const AddMinter = ({ web3Token, tokenData, refreshDataGrid }) => {
  ...
  const onClickMint = async () => {
    ...
    try {
      ...
      await web3Token.methods.addMinter(data.arg1).send({ from: accounts[0] });
      successMessage = `Add successful. ${data.arg1} had been add`;
      refreshDataGrid();
    } catch (error) {
